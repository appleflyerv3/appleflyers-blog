...
1. connect ur flasher back duh and try to write your old ROM file back
    ...
    ```
2. if it doesnt work still, try and use this [guide](https://wiki.mrchromebox.com/Unbricking)
...
+ tn kajigs [stuff in TN discord]
*(as of mar 22 2024)*

# Credits
This information is not mine. I have merely compiled information from other people's blog posts and other people. Credits are below.
Credits:
...
+ huge credit to darkn 
+ <https://osu.bio/sh1mmer/kiosk>
+ chultrabook forums
